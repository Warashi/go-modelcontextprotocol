...
## [v0.0.9](https://github.com/Warashi/go-modelcontextprotocol/compare/v0.0.8...v0.0.9) - 2025-12-20
...
- chore(deps): bump github/codeql-action from 3.30.6 to 4.30.8 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/62
- chore(deps): bump github/codeql-action from 4.30.8 to 4.30.9 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/63
- chore(deps): bump github/codeql-action from 4.30.9 to 4.31.2 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/65
- chore(deps): bump github/codeql-action from 4.31.2 to 4.31.3 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/66
- chore(deps): bump actions/checkout from 5.0.0 to 6.0.0 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/67
- chore(deps): bump actions/create-github-app-token from 2.1.4 to 2.2.0 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/68
- chore(deps): bump github/codeql-action from 4.31.3 to 4.31.4 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/69
- chore(deps): bump actions/setup-go from 6.0.0 to 6.1.0 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/70
- chore(deps): bump github/codeql-action from 4.31.4 to 4.31.5 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/71
- chore(deps): bump Songmu/tagpr from 1.9.0 to 1.9.2 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/76
- chore(deps): bump github/codeql-action from 4.31.5 to 4.31.8 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/75
- chore(deps): bump actions/create-github-app-token from 2.2.0 to 2.2.1 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/73
- chore(deps): bump actions/checkout from 6.0.0 to 6.0.1 by @dependabot[bot] in https://github.com/Warashi/go-modelcontextprotocol/pull/72
